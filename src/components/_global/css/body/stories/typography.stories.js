...
export const AllThemesGlobalElements = {
  args: { ...exampleAll, templateFile: exampleAllThemesTemplate },
  globals: { theme: "Disabled" },
  parameters: {
    // Disables Chromatic's snapshotting on a component level
...
export const HyperlinkUnderlinesExample = {
  args: { ...underlinesExampleJson, templateFile: underlinesExampleTemplate },
  globals: {},
};
...
export const SpacingExample = {
  args: { ...spacingExampleJson, templateFile: spacingExampleTemplate },
  globals: {},
};
...
export const SpacingExample2 = {
  args: { ...spacingExample2Json, templateFile: spacingExample2Template },
  globals: {},
};
