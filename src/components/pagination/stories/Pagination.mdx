...
[//]: # "/*Hides two of the colour options that are not available for this component */ .qld__body .qld__code .qld__code-preview-colours ul li:nth-child(2), .qld__body .qld__code .qld__code-preview-colours ul li:nth-last-child(1) { display: none; }"
