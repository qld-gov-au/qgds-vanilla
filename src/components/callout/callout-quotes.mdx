...
| Name | Description |
|------|-------------|
| `$QLD-color-light-designAccent` | Colour of design accent used on light backgrounds for callouts,  and other decorative borders. |
| `$QLD-color-dark-designAccent` | Colour of design accent used on dark backgrounds for callouts,  and other decorative borders. |
